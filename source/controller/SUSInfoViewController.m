...
@interface SUSInfoViewController ()

@end

@implementation SUSInfoViewController
...
- (id)init
{
    ...
    self = [super initWithNibName:@"SUSInfoViewController" bundle:nil];
    if (!self) {
        return nil;
    }
...
- (void)viewDidLoad
{
    ...
    NSURLRequest* request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://startupstory.biz/for_mbmenu/"]];
